...
const UnUsedCharts = () => {
  return (
    <>
      ...
      <VerticalBarChart data={percentageData(data.marketInsightEducationStatusData)} title="میزان شناخت بازار کار به تفکیک وضعیت تحصیلی" />
      ...
      <VerticalBarChart data={percentageData(data.majorSatisfactionSexData)} title="میزان رضایت از انتخاب رشته به تفکیک جنسیت" />
